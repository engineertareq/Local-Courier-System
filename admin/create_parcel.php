...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sender_phone = $_POST['sender_phone'];     // Added
    $sender_address = $_POST['sender_address']; // Added
    ...
    try {
        ...
        // UPDATED: Added weight_kg, sender_phone, sender_address. 
        ...
        $stmt->execute([
            $tracking_number, 
            $sender, 
            $sender_phone,    // Captured from form
            $sender_address,  // Captured from form
            $receiver, 
            $receiver_phone, 
            $receiver_address, 
            $weight,          // Storing weight_kg
            $calculated_price,
            $payment_method,
            $branch_id
        ]);
        ...
        $desc = "Order placed. Status: Pending. Type: $parcel_type, Weight: {$weight}KG, Loc: " . ucfirst($location) . ". Method: $payment_method";
              ...
              <div class="row gy-3">
                ...
                <div class="col-md-4">
                  ...
                  <div class="icon-field">
                    ...
                    <input type="text" name="sender_phone" class="form-control" placeholder="Sender Phone" required>
                  </div>
                </div>
                ...
                <div class="col-md-4">
                  ...
                  <div class="icon-field">
                    ...
                    <input type="text" name="sender_address" class="form-control" placeholder="Sender Address" required>
                  </div>
                </div>
