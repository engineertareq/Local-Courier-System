...
session_start();
require 'db.php';
include 'inc/header.php'; // Includes your dashboard sidebar/nav
                ...
                <div class="col-lg-8">
                    <form method="GET" class="position-relative">
                        <input type="text" name="tracking_number" 
                               ...
                               value="<?= isset($_GET['tracking_number']) ? htmlspecialchars($_GET['tracking_number']) : '' ?>" 
                               required>
    ...
    <?php elseif ($search_performed): ?>
        <div class="card h-100 p-0 radius-12">
            <div class="card-body p-24 text-center">
                ...
                <p class="text-secondary-light">We couldn't find any parcel with the ID <strong><?= htmlspecialchars($_GET['tracking_number']) ?></strong>.</p>
